    ...
    if (self) {
        [dict enumerateKeysAndObjectsUsingBlock:^(NSString *key, id obj, BOOL *stop) {
            if (![obj isKindOfClass:[NSNull class]]) {
                if ([key isEqualToString:@"cover_path"]||[key isEqualToString:@"albumCoverUrl290"]||[key isEqualToString:@"vod_pic"]||[key isEqualToString:@"cover"]) {
                ...
                }else if ([key isEqualToString:@"vod_content"]||[key isEqualToString:@"shortIntro"]) {

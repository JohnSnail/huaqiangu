...
// DomobAdSDK
#define COCOAPODS_POD_AVAILABLE_DomobAdSDK
#define COCOAPODS_VERSION_MAJOR_DomobAdSDK 4
#define COCOAPODS_VERSION_MINOR_DomobAdSDK 4
#define COCOAPODS_VERSION_PATCH_DomobAdSDK 8
